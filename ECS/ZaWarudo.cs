...
//		private readonly IEnumerable<S.System> _systems;
//		private readonly Dictionary<Type, S.System> _systemDictionary;
...
//			_systemDictionary = new Dictionary<Type, S.System>();
...
//			_systems = GetSystems();
//			foreach(S.System system in _systems)
//				RegisterSystem(system);
//		}

//		private S.System[] GetSystems() => new S.System[]{
...
//		public T GetSystem<T>() where T : S.System
...
//		public void EnableSystem<T>() where T : S.System {
...
//		public void DisableSystem<T>() where T : S.System {
...
//		private void End() {
//			foreach(S.System system in _enabledUpdateSystems.Values) {
//				system.GetType().GetMethod("OnDisable", MESSAGE_FLAGS)?.Invoke(system, null);
//			}
//			_enabledUpdateSystems.Clear();
//			foreach(S.System system in _enabledDrawSystems.Values) {
//				system.GetType().GetMethod("OnDisable", MESSAGE_FLAGS)?.Invoke(system, null);
//			}
//			_enabledDrawSystems.Clear();

//			foreach(S.System system in _updateSystems.Values) {
//				system.GetType().GetMethod("OnEnd", MESSAGE_FLAGS)?.Invoke(system, null);
//			}
//			foreach(S.System system in _drawSystems.Values) {
//				system.GetType().GetMethod("OnEnd", MESSAGE_FLAGS)?.Invoke(system, null);
//			}
//		}

//		private void RegisterSystem(S.System system) {
